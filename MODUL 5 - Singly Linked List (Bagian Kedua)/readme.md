# <h1 align="center">Laporan Praktikum Singly Linked List (Bagian Kedua)</h1>
...
```
Kode di atas digunakan untuk mengimplementasikan struktur data Singly Linked List pada bahasa C++ dengan objek data berupa informasi buah.
## Unguided 
...
```
#### Output:
<img width="482" height="166" alt="Image" src="https://github.com/user-attachments/assets/6421305f-d0c7-4954-afb6-19b2d18f3fe1" />

Program di atas digunakan untuk membuat dan mengelola singly linked list sederhana yang menyimpan data bertipe integer.

#### Full code Screenshot:
<img width="476" height="764" alt="Image" src="https://github.com/user-attachments/assets/cd3ea789-7e89-49ec-94e7-d1543ee1ecc3" />
<img width="464" height="945" alt="Image" src="https://github.com/user-attachments/assets/44ac0be9-18ee-4c04-a871-be0583b331f4" />
<img width="800" height="769" alt="Image" src="https://github.com/user-attachments/assets/aec77a1b-2366-42e7-99d1-f5cce1a77742" />

## Kesimpulan

Kesimpulan nya adalah Program ini menunjukkan bahwa singly linked list merupakan salah satu struktur data yang efisien dalam pengelolaan data secara dinamis. 
Melalui implementasi menggunakan bahasa C++, program berhasil menampilkan bagaimana node-node dapat saling terhubung menggunakan pointer tanpa batasan ukuran 
tetap seperti pada array.
